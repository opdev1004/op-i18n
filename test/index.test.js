...
let nameList = i18n.getNames();
console.log(nameList);
let isoList = i18n.getISOs();
console.log(isoList);
console.log(i18n.getDefaultName());
console.log(i18n.getDefaultISO());
i18n.updateDefaultLocale("en_US");
console.log(i18n.$t("fullname.first"));
i18n.updateDefaultLocaleByName("한국어");
console.log(i18n.$t("fullname.first"));